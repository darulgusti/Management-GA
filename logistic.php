            ...
            <div class="modal-body">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.25rem;">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm" style="display: inline-flex; align-items: center; justify-content: center; gap: 0.35rem; width: 100%; padding: 0.6rem; font-weight: 600;" onclick="document.getElementById('camera_input_edc').click();">
        ...
        <form method="POST" action="logistic.php?tab=<?= urlencode($active_tab) ?>">
            ...
            <div class="modal-body">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.25rem;">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        <label class="form-label" style="font-weight: 600;">Upload Foto Surat Jalan / Dokumen <small style="color: var(--text-muted); font-weight: 400;">(Opsional)</small></label>
                        <button type="button" class="btn btn-secondary btn-sm" style="display: inline-flex; align-items: center; justify-content: center; gap: 0.35rem; width: 100%; padding: 0.6rem; font-weight: 600;" onclick="document.getElementById('camera_input_nex').click();">
                            📷 Ambil Foto dari Kamera
                        </button>
    ...
    <div class="modal-dialog" style="max-width: 720px; width: 95%;">
        ...
        <form method="POST" action="logistic.php?tab=<?= urlencode($active_tab) ?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" style="font-weight: 600;">Upload Foto Surat Jalan <small style="color: var(--text-muted); font-weight: 400;">(Opsional)</small></label>
                    <button type="button" class="btn btn-secondary btn-sm" style="display: inline-flex; align-items: center; justify-content: center; gap: 0.35rem; width: 100%; padding: 0.6rem; font-weight: 600;" onclick="document.getElementById('camera_input_co_ajinex').click();">
                        📷 Ambil Foto dari Kamera
                    </button>
    ...
    <div class="modal-dialog" style="max-width: 650px; width: 95%;">
        ...
        <form method="POST" action="logistic.php?tab=<?= urlencode($active_tab) ?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" style="font-weight: 600;">Upload Foto Surat Jalan <small style="color: var(--text-muted); font-weight: 400;">(Opsional)</small></label>
                    <button type="button" class="btn btn-secondary btn-sm" style="display: inline-flex; align-items: center; justify-content: center; gap: 0.35rem; width: 100%; padding: 0.6rem; font-weight: 600;" onclick="document.getElementById('camera_input_co_edc').click();">
                        📷 Ambil Foto dari Kamera
                    </button>
