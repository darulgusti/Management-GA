...
<!-- SECTION MONITORING LOGISTIK (DIPISAH MENJADI 3 SUB-MODUL) -->
<div style="margin-bottom: 1rem; border-bottom: 2px solid var(--border); padding-bottom: 0.5rem; display: flex; justify-content: space-between; align-items: center;">
    <h2 style="font-size: 1.25rem; font-weight: 700; color: var(--primary); margin: 0;">
        🚛 Monitoring Lalu Lintas Logistik Pos Gerbang (3 Sub-Modul)
    </h2>
    <a href="logistic.php" class="btn btn-sm btn-primary">Kelola Semua Logistik →</a>
</div>

<!-- Stat Cards Row 2: Monitoring 3 Sub-modul Logistik -->
<div class="grid-3" style="margin-bottom: 1.5rem;">
    <div class="stat-card" style="border-left: 4px solid var(--primary);">
        ...
        <div class="stat-content">
            ...
            <div class="stat-label">1. Gate In (Armada Masuk) Hari Ini</div>
        </div>
    </div>
    ...
    <div class="stat-card" style="border-left: 4px solid var(--info);">
        ...
        <div class="stat-content">
            ...
            <div class="stat-label">2. Gate Out (Armada Keluar) Hari Ini</div>
        </div>
    </div>
    ...
    <div class="stat-card" style="border-left: 4px solid var(--success);">
        ...
        <div class="stat-content">
            ...
            <div class="stat-label">3. Export NEX/MOPOR Hari Ini</div>
        </div>
    </div>
</div>

<!-- 3 TABEL LOGISTIK TERPISAH (GATE IN, GATE OUT, EXPORT NEX/MOPOR) -->
<div class="grid-3">
    <!-- Tabel 1: Gate In -->
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">1. Gate In (Armada Masuk)</h3>
            <a href="logistic.php#sec-gate-in" class="btn btn-sm btn-outline">Lihat →</a>
        </div>
        <div class="table-responsive">
            <table class="table">
                <thead>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">2. Gate Out (Armada Keluar)</h3>
            <a href="logistic.php#sec-gate-out" class="btn btn-sm btn-outline">Lihat →</a>
        </div>
        <div class="table-responsive">
            <table class="table">
                <thead>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="logistic.php#sec-export" class="btn btn-sm btn-outline">Lihat →</a>
        </div>
        <div class="table-responsive">
            <table class="table">
                <thead>
